...
const App: React.FC = () => {
  ...
  // Add a fade-in animation style (can be enhanced with Tailwind config if needed)
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-950 to-slate-900 text-slate-100 flex flex-col items-center justify-center p-4 sm:p-6 overflow-hidden">
      ...
      <div className="w-full h-full flex items-center justify-center">
       ...
       <footer className="absolute bottom-4 text-center text-xs text-slate-500 w-full">
        <p>Tarot numérico &copy; {new Date().getFullYear()}</p>
      </footer>
    </div>
  );
};
